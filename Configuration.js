...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "Methane sensor reading", endpointType.ppmConcentrationSensor);
  var e = endpoints.addEndpoint("2", "Methane sensor status", endpointType.genericSensor);
  e.variableTypeId = 1428;
  endpoints.addEndpoint("3", "Oxygen sensor reading", endpointType.ppmConcentrationSensor);
  var e = endpoints.addEndpoint("4", "Oxygen sensor status", endpointType.genericSensor);
  e.variableTypeId = 1428;
}
